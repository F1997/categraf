...
var defaultStats = map[string]string{
	...
	"network_bytes_out":                  "NetworkOutBytes",
	"network_bytes_in":                   "NetworkInBytes",
	"global_lock_total_time":             "GlobalLockTotalTime",
	"global_lock_lock_time":              "GlobalLockLockTime",
	"global_lock_current_queue":          "GlobalLockCurrentQueue",
	"global_lock_active_clients_total":   "GlobalLockActiveClientsTotal",
	"global_lock_active_clients_readers": "GlobalLockActiveClientsReaders",
	"global_lock_active_clients_writers": "GlobalLockActiveClientsWriters",
}
