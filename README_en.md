...
[![Powered By Flashcat](https://img.shields.io/badge/Powered%20By-Flashcat-blueviolet)](https://github.com/F1997/)
...
It is recommended that you use [Nightingale](https://github.com/ccfos/nightingale) as the backend observability tools, and at the same time use [FlashDuty](https://github.com/F1997/product/flashduty?from=categraf) as the OnCall system to realize alarm aggregation convergence, claiming, upgrading, scheduling, and coordination, so that the alarm can be reached efficiently and ensure that the alarm processing is not missed, so that every piece echoed.


## Links

- [QuickStart](https://github.com/F1997/blog/monitor-agent-categraf-introduction/)
...
## [Join wechat groups](https://download.github.com/F1997/qrcode_sretalk.jpg)
